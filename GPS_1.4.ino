...
//Set Value
int Parking_point;
//int Parking_point_gps;
String device_id = "GPS tracking 1";
unsigned long Buzzer_time = 0;
#define Buzzer_time_delay 5000;
//Json config
...
void displayInfo()
{
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////
  /*
  if (gps.location.lat() == gps.location.lat() and gps.location.lng() == gps.location.lng()) {
    Parking_point_gps++;
  } else if (gps.location.lat() != gps.location.lat() and gps.location.lng() != gps.location.lng()) {
    Parking_point_gps = 0;
  }
  if (Parking_point_gps == 10) {
    Parking_point_gps = 0;
  }
  */
  /////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /*
  if (Parking_point == 10) {
    if (millis() - Buzzer_time > Buzzer_time_delay) {
      Buzzer_time = millis();
  ...
  */
  ...
  Serial.println();
  Serial.print("Parking_point : ");
  Serial.println(Parking_point); //
  Serial.println("=============");
  delay(3000);
  lcd.clear();
  lcd.setCursor(3, 0);
